...
export default function UserDropdown() {
  ...
  // Get user details from session or fallback
  const fullName = session?.user?.fullName || "Owner / Kasir";
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex items-center justify-center rounded-full h-11 w-11 bg-brand-500 text-white font-bold text-lg overflow-hidden">
          {initial}
        </span>
